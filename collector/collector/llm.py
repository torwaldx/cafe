...
Описание должно быть основано на пользовательском тексте, состоять из двух предложений в неофициальном стиле.
...
Все заведения, НЕ ОТНОСЯЩИЕСЯ к категории общественного питания (в том числе музеи, выставки, студии, мероприятия, культурные заведения), должны быть ПРОИГНОРИРОВАНЫ.
